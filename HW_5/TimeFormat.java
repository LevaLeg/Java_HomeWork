...
//        Объяснение: в переменную n должно записываться случайное (на время тестирования программы) целое
...
public class TimeFormat
{
    ...
    {
        return (int) (Math.random() * 28801); // Получение псевдослучайных чисел от 0 до 28800.
    }
    ...
    public static void main(String[] args)
    {
            ...
            if ((h > 4) && (h < 9)) {
                ...
                System.out.println("До конца рабочего дня остался " + h + " час.");
            }
            else {
